...
const ShowProductosAdmin = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post(
                "http://localhost/cyberdoor/public/api/productUpdate",
                formData,
                {
                    headers: {
    ...
    const Editar = (e) => {
        history.push("/cyberdoor/public/UpdateProducto");
    }
    const Crear = (e) => {
        history.push("/cyberdoor/public/RegistraProducto");
    }
    const Borrar = (e) => {
        history.push("/cyberdoor/public/DeleteProduct");
    }
    ...
    const Buttons = (props) => {
        const eliminaProducto = () => {
            ...
            axios
                .post(
                    "http://localhost/cyberdoor/public/api/productDelete",
                    formData,
                    {
                        headers: {
                            "Content-Type": "multipart/form-data",
        ...
        return (
            <>
                <Button variant="danger" onClick={eliminaProducto}>BORRAR </Button>{' '}
                <Button variant="primary" onClick={actualizarProducto}> Editar </Button>
            </>
        )
    }
    return (
